...
import { Mail, Lock, Eye, EyeOff, Zap, UserPlus, ArrowRight, Package } from 'lucide-react';
      ...
      >
        ...
        <div className="glass-strong rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-center justify-end">
            <button onClick={() => router.push('/courier/recovery')} className="text-xs text-orange-400 hover:underline">

...
import { Mail, Lock, Eye, EyeOff, Zap, UserPlus, ArrowRight, Car } from 'lucide-react';
      ...
      >
        ...
        <div className="glass-strong rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-center justify-end">
            <button onClick={() => router.push('/driver/recovery')} className="text-xs text-cyan-400 hover:underline">

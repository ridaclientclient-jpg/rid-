...
import { Mail, Lock, Eye, EyeOff, Zap, UserPlus, ArrowRight, Car, Chrome, Phone, ArrowLeft, RotateCcw } from 'lucide-react';
        ...
        try {
          ...
          if (!existingProfile) {
            ...
            await supabase.from('profiles').upsert({
              id: data.user.id,
              name: meta.name || meta.phone || `Conductor ${cleanPhone.slice(-4)}`,
    ...
    <div className="min-h-screen bg-rida-dark flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">RIDA CONDUCTOR</h1>
          <p className="text-sm text-cyan-400/70">Conduce y gana con RIDA</p>
        </div>
            ...
            {authView === 'email' && (
              ...
              >
                ...
                <div className="flex items-center justify-end">
                  <button type="button" onClick={() => router.push('/driver/recovery')} className="text-xs text-cyan-400 hover:underline">
